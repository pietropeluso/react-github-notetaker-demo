...
var base = Rebase.createClass("https://github-notetaker-react.firebaseio.com");
  ...
  render() {
    ...
    return (
      <div className="row">
        ...
        <div className="col-md-4">
          <Notes username={username} notes={this.state.notes} addNote={this.handleNewNote.bind(this)} />
        </div>
      </div>
    )
  }
